...
//#define OPT3001_FLAG_HIGH    0x0040 // Flag set to 1 when res is more than I2C_LIGHT_HIGH_LIM
//#define OPT3001_FLAG_LOW     0x0020 // Flag set to 1 when res is less than I2C_LIGHT_HIGH_LIM
